...
## [0.38.0](https://github.com/Aryan-Shrivastva/EZ/compare/v0.37.0...v0.38.0) (2026-01-05)


### Features

* `ensure` keyword for guaranteed cleanup on function exit [#804](https://github.com/Aryan-Shrivastva/EZ/issues/804) ([#864](https://github.com/Aryan-Shrivastva/EZ/issues/864)) ([cbef798](https://github.com/Aryan-Shrivastva/EZ/commit/cbef7983e727a194b4453fc38e48e83ac2fb319a))
* add `@JSON` module, raw strings, and restrict `any` type ([8e566e5](https://github.com/Aryan-Shrivastva/EZ/commit/8e566e5c73e9cd14c595f7b63dbed93104745f1f))
* add default parameter values for functions ([#312](https://github.com/Aryan-Shrivastva/EZ/issues/312)) ([#485](https://github.com/Aryan-Shrivastva/EZ/issues/485)) ([933ca6f](https://github.com/Aryan-Shrivastva/EZ/commit/933ca6fe278654cfea9a1172e4a3eb0419f05f58))
* add error() constructor for user-defined errors ([95a85fe](https://github.com/Aryan-Shrivastva/EZ/commit/95a85fed06360177d671cb18dedd1bf55e465be2))
* add error() constructor for user-defined errors ([#292](https://github.com/Aryan-Shrivastva/EZ/issues/292)) ([4f2bc5e](https://github.com/Aryan-Shrivastva/EZ/commit/4f2bc5eed24b63d31d9b3bc76c44035260a74434))
* add JSON module, raw strings, and restrict 'any' type ([f66b734](https://github.com/Aryan-Shrivastva/EZ/commit/f66b734823d38dc9c40312044e25905cda096374))
* add line editor for REPL with arrow key navigation and history ([#400](https://github.com/Aryan-Shrivastva/EZ/issues/400)) ([bce7343](https://github.com/Aryan-Shrivastva/EZ/commit/bce7343118564ec2f8b7b2e79b2eec3cd0b49711))
* add PowerShell install script for Windows ([e5ca88b](https://github.com/Aryan-Shrivastva/EZ/commit/e5ca88bc7595be9beea852117c88d6c704cf3644))
* add PowerShell install script for Windows ([2244edb](https://github.com/Aryan-Shrivastva/EZ/commit/2244edbb6c0b74f32e697710273ca459c1fc0a00)), closes [#806](https://github.com/Aryan-Shrivastva/EZ/issues/806)
* add update checker and `ez update` command ([#478](https://github.com/Aryan-Shrivastva/EZ/issues/478)) ([#479](https://github.com/Aryan-Shrivastva/EZ/issues/479)) ([a33c92b](https://github.com/Aryan-Shrivastva/EZ/commit/a33c92be20dc111bf0d8a1529b7a06b7f3b7522b))
* add W2010 warning for chained member access on nullable structs ([#689](https://github.com/Aryan-Shrivastva/EZ/issues/689)) ([cd57753](https://github.com/Aryan-Shrivastva/EZ/commit/cd57753bd3858e2e8b33ca230661c9c23b416934))
* add W2010 warning for chained member access on nullable structs ([#689](https://github.com/Aryan-Shrivastva/EZ/issues/689)) ([3cd1ede](https://github.com/Aryan-Shrivastva/EZ/commit/3cd1ede848574aa97f0b697905ffce283a7d713b))
* add warning for unused imports ([#639](https://github.com/Aryan-Shrivastva/EZ/issues/639)) ([#844](https://github.com/Aryan-Shrivastva/EZ/issues/844)) ([d299bcd](https://github.com/Aryan-Shrivastva/EZ/commit/d299bcdcbc750037d68ceb591c94c951abcf1152))
* add when/is switch statements ([#179](https://github.com/Aryan-Shrivastva/EZ/issues/179)) ([#491](https://github.com/Aryan-Shrivastva/EZ/issues/491)) ([4f0c068](https://github.com/Aryan-Shrivastva/EZ/commit/4f0c0689c8efcf3b2dbf8bd08764fb5b0fa510eb))
* add`[@http](https://github.com/http)` module HTTP client for web requests ([#877](https://github.com/Aryan-Shrivastva/EZ/issues/877)) ([34a874f](https://github.com/Aryan-Shrivastva/EZ/commit/34a874f753f68ff8fbd52ea83a9ff179dad3b2fd))
* added workflow for checking PR validity based on filetype ([632d8bd](https://github.com/Aryan-Shrivastva/EZ/commit/632d8bdf1b58fd9316ca5af5e2f13aed143168ff))
* allow range() in if/in expressions and when/is statements ([#501](https://github.com/Aryan-Shrivastva/EZ/issues/501)) ([#505](https://github.com/Aryan-Shrivastva/EZ/issues/505)) ([de2890f](https://github.com/Aryan-Shrivastva/EZ/commit/de2890f16bcd738adca6de3803d93c8e1dabddef))
* allow type inference for const declarations ([279afc8](https://github.com/Aryan-Shrivastva/EZ/commit/279afc80d91d072a3b35aa85372bd3ea9ae6c893))
* allow type inference for const declarations ([#302](https://github.com/Aryan-Shrivastva/EZ/issues/302)) ([ff94be9](https://github.com/Aryan-Shrivastva/EZ/commit/ff94be94f855368dc08f67efe0cee3d398a0b8df))
* ASCII art banner ([#855](https://github.com/Aryan-Shrivastva/EZ/issues/855)) ([4ccaea8](https://github.com/Aryan-Shrivastva/EZ/commit/4ccaea8989729e55beb068cc0ee0cd5aec8389f8))
* **examples:** add price calculator example ([#848](https://github.com/Aryan-Shrivastva/EZ/issues/848)) ([70d10b7](https://github.com/Aryan-Shrivastva/EZ/commit/70d10b721970f2fb266c892128b974ad9d069f15))
* global builtins, [@std](https://github.com/std) expansion, and bug fixes ([#525](https://github.com/Aryan-Shrivastva/EZ/issues/525), [#526](https://github.com/Aryan-Shrivastva/EZ/issues/526), [#522](https://github.com/Aryan-Shrivastva/EZ/issues/522), [#523](https://github.com/Aryan-Shrivastva/EZ/issues/523), [#524](https://github.com/Aryan-Shrivastva/EZ/issues/524), [#527](https://github.com/Aryan-Shrivastva/EZ/issues/527)) ([#532](https://github.com/Aryan-Shrivastva/EZ/issues/532)) ([accd080](https://github.com/Aryan-Shrivastva/EZ/commit/accd0803e711b1327d2f4b0ee6c334f04c600846))
* **http:** add HTTP status code constants ([#907](https://github.com/Aryan-Shrivastva/EZ/issues/907)) ([5ce155d](https://github.com/Aryan-Shrivastva/EZ/commit/5ce155d7163d83a3f6bd68ba5e3be618de58b4ac))
* implement ref() builtin and copy-by-default semantics ([#661](https://github.com/Aryan-Shrivastva/EZ/issues/661)) ([743153c](https://github.com/Aryan-Shrivastva/EZ/commit/743153cee33eb181622433e489dc0fa94d62a701))
* implement ref() builtin and copy-by-default semantics ([#661](https://github.com/Aryan-Shrivastva/EZ/issues/661)) ([d064e56](https://github.com/Aryan-Shrivastva/EZ/commit/d064e56e894206ba2a2074a03f75bca15949de14))
* **lang:** add `cast()` keyword for type conversion ([0cc34f2](https://github.com/Aryan-Shrivastva/EZ/commit/0cc34f24c469efaac6602765958c356eff36a4d7))
* **lang:** add cast() keyword for type conversion ([ab814f8](https://github.com/Aryan-Shrivastva/EZ/commit/ab814f8ca127598625d37c0a1092ed9ef4a1054f)), closes [#717](https://github.com/Aryan-Shrivastva/EZ/issues/717)
* multi-value handling improvements ([5b533d1](https://github.com/Aryan-Shrivastva/EZ/commit/5b533d1a40ea3e3f3477f9a0805acd3a17113d39))
* **parser:** support tuple unpacking in assignment statements ([#699](https://github.com/Aryan-Shrivastva/EZ/issues/699)) ([#704](https://github.com/Aryan-Shrivastva/EZ/issues/704)) ([1c01533](https://github.com/Aryan-Shrivastva/EZ/commit/1c015336253968ce0d1655580103116de6aff52c))
* replace [@ignore](https://github.com/ignore) with _ (underscore) blank identifier ([#376](https://github.com/Aryan-Shrivastva/EZ/issues/376)) ([66111be](https://github.com/Aryan-Shrivastva/EZ/commit/66111beaf80ca72dab092a9b0e62b1fa5e4da58a))
* stdlib additions and bug fixes ([88791f4](https://github.com/Aryan-Shrivastva/EZ/commit/88791f4a39b32b68365b5f50e977f763839d9a96))
* **stdlib:** add [@binary](https://github.com/binary) module and sized type conversions ([496f874](https://github.com/Aryan-Shrivastva/EZ/commit/496f87433c5f5f6a84f80af4b39f66194f309a6b))
* **stdlib:** add [@binary](https://github.com/binary) module and sized type conversions ([9487a65](https://github.com/Aryan-Shrivastva/EZ/commit/9487a65fd48c8e9bb6a8ebcf9440fae5e3d14625)), closes [#716](https://github.com/Aryan-Shrivastva/EZ/issues/716)
* **stdlib:** add [@crypto](https://github.com/crypto) module for hashing and secure random ([9a38974](https://github.com/Aryan-Shrivastva/EZ/commit/9a3897430d77b6561d6dee76c34e50fcdf5f317d)), closes [#458](https://github.com/Aryan-Shrivastva/EZ/issues/458)
* **stdlib:** add [@db](https://github.com/db) module for simple key-value database ([342a4f9](https://github.com/Aryan-Shrivastva/EZ/commit/342a4f922911cebf1a56eda176a83874b907cdf4))
* **stdlib:** add [@db](https://github.com/db) module for simple key-value database ([23e112a](https://github.com/Aryan-Shrivastva/EZ/commit/23e112a3d9086ce9baf9ce66f6e8b936ed6c3932)), closes [#460](https://github.com/Aryan-Shrivastva/EZ/issues/460)
* **stdlib:** add [@encoding](https://github.com/encoding) module with base64, hex, and URL functions ([58cf8b6](https://github.com/Aryan-Shrivastva/EZ/commit/58cf8b6301769e58d323816bff6fe794ff6f55b6))
* **stdlib:** add [@random](https://github.com/random) module with comprehensive random functions ([0f2f981](https://github.com/Aryan-Shrivastva/EZ/commit/0f2f981b0ef78b90e653190100d521f7b91d6a3f)), closes [#309](https://github.com/Aryan-Shrivastva/EZ/issues/309)
* **stdlib:** add [@uuid](https://github.com/uuid) module for UUID generation ([e283602](https://github.com/Aryan-Shrivastva/EZ/commit/e283602315cffdf0f46635b55baf1fcff8bdf38a)), closes [#759](https://github.com/Aryan-Shrivastva/EZ/issues/759)
* **stdlib:** add `strings.to_int()`, `strings.to_float()`, `strings.to_bool()` ([846f90a](https://github.com/Aryan-Shrivastva/EZ/commit/846f90af5f781c96bc13e983d4e2e183e30d6dd4))
* **stdlib:** add command execution functions to [@os](https://github.com/os) ([b8b2e04](https://github.com/Aryan-Shrivastva/EZ/commit/b8b2e04475d8a2c31b751fa8a2cbe673d574deb2))
* **stdlib:** add db.exists() and db.update_key_name() ([f89aac1](https://github.com/Aryan-Shrivastva/EZ/commit/f89aac142eb5344e7bc86a4500353a1d9cd2c74b))
* **stdlib:** add db.sort() with sort order constants ([8a26dab](https://github.com/Aryan-Shrivastva/EZ/commit/8a26dab2c040d2372b004c97d71b9e15363794ed)), closes [#782](https://github.com/Aryan-Shrivastva/EZ/issues/782)
* **stdlib:** add filesystem utilities to [@io](https://github.com/io) ([bf0e035](https://github.com/Aryan-Shrivastva/EZ/commit/bf0e0359f1c01236e73f706e497329e5506284c5)), closes [#287](https://github.com/Aryan-Shrivastva/EZ/issues/287)
* **stdlib:** add math.log_base() for arbitrary base logarithms ([7b304f6](https://github.com/Aryan-Shrivastva/EZ/commit/7b304f6fed3fd54247daaa74288a4f7eb22ef404))
* **stdlib:** add new string utility functions to [@strings](https://github.com/strings) ([7cce6fd](https://github.com/Aryan-Shrivastva/EZ/commit/7cce6fd96551c8ebdc91c055a607ed439e35e7cf)), closes [#285](https://github.com/Aryan-Shrivastva/EZ/issues/285)
* **stdlib:** add strings.to_int(), strings.to_float(), strings.to_bool() ([e496f23](https://github.com/Aryan-Shrivastva/EZ/commit/e496f231bafb51979f7127a7c8a26516df365afb)), closes [#651](https://github.com/Aryan-Shrivastva/EZ/issues/651)
* **stdlib:** expand standard library with new modules and functions ([401203e](https://github.com/Aryan-Shrivastva/EZ/commit/401203eb730037dfc3579b810b18097d77617fc7))
* Struct field tags JSON customization ([ae64d0a](https://github.com/Aryan-Shrivastva/EZ/commit/ae64d0aeb925d572b57c9a5898ed2753bcec0866))
* **typechecker:** add type checking for all stdlib modules ([8842961](https://github.com/Aryan-Shrivastva/EZ/commit/88429612f75394597e66db37d99180ea9e90d76d))
* **typechecker:** add type checking for all stdlib modules ([fc1f4e8](https://github.com/Aryan-Shrivastva/EZ/commit/fc1f4e8364aeef6e43a2451629d010d542224dd6))
* **typechecker:** comprehensive typechecker overhaul with ref() builtin ([e05a459](https://github.com/Aryan-Shrivastva/EZ/commit/e05a4591c8be5a5a0f99eb04fe833fd3542e7021))
* **typechecker:** detect literal division/modulo by zero ([8ce1a11](https://github.com/Aryan-Shrivastva/EZ/commit/8ce1a1124f8de946cd6f283b427eb242a0e97faf))
* **typechecker:** detect literal division/modulo by zero ([#667](https://github.com/Aryan-Shrivastva/EZ/issues/667)) ([76b4f1e](https://github.com/Aryan-Shrivastva/EZ/commit/76b4f1e2da6d955787e394fb1fab07eb872b8e0a))
* **typechecker:** detect undefined variables and functions at check time ([#663](https://github.com/Aryan-Shrivastva/EZ/issues/663)) ([4ca2c68](https://github.com/Aryan-Shrivastva/EZ/commit/4ca2c68a56b82fc2917f4121373ff862bf715fdd))
* **typechecker:** detect undefined variables and functions at check time ([#663](https://github.com/Aryan-Shrivastva/EZ/issues/663)) ([5334c4b](https://github.com/Aryan-Shrivastva/EZ/commit/5334c4bb39363c1ec27994991d01ebc4792f6591))
* **typechecker:** reject executable statements at file scope ([c2b372f](https://github.com/Aryan-Shrivastva/EZ/commit/c2b372f0ec6ecbd0868a8a75b81d8fa2561abe1e))
* **typechecker:** reject executable statements at file scope ([#662](https://github.com/Aryan-Shrivastva/EZ/issues/662)) ([9ec3cd0](https://github.com/Aryan-Shrivastva/EZ/commit/9ec3cd0c4155840dc1fa21f17a838c10fe470ce7))
* **typechecker:** validate integer literal ranges for sized types ([c315995](https://github.com/Aryan-Shrivastva/EZ/commit/c3159952bd246079c6671e0883b2c4ae8867b03b))
* **typechecker:** validate integer literal ranges for sized types ([#666](https://github.com/Aryan-Shrivastva/EZ/issues/666)) ([0d7cdfe](https://github.com/Aryan-Shrivastva/EZ/commit/0d7cdfea655141e0a31359f17e66f95418072b91))


### Bug Fixes

* [@strict](https://github.com/strict) when enforces enum exhaustiveness at compile time ([#629](https://github.com/Aryan-Shrivastva/EZ/issues/629)) ([f549a3b](https://github.com/Aryan-Shrivastva/EZ/commit/f549a3bd63c013f13cdb3bb4987f061ff794a0d1))
* [@strict](https://github.com/strict) when rejects non-enum expressions ([#628](https://github.com/Aryan-Shrivastva/EZ/issues/628)) ([c734b18](https://github.com/Aryan-Shrivastva/EZ/commit/c734b1845b109643f8aa1c5d7acb91fab7e3c232))
* [@strict](https://github.com/strict) when rejects non-enum expressions in cases ([#628](https://github.com/Aryan-Shrivastva/EZ/issues/628)) ([799b7a7](https://github.com/Aryan-Shrivastva/EZ/commit/799b7a7fd3035eae677fb9388d25eef06d09fa1a))
* #suppress before function now correctly applies to function only ([#830](https://github.com/Aryan-Shrivastva/EZ/issues/830), [#831](https://github.com/Aryan-Shrivastva/EZ/issues/831)) ([#832](https://github.com/Aryan-Shrivastva/EZ/issues/832)) ([6837668](https://github.com/Aryan-Shrivastva/EZ/commit/68376685eab9e4aeec51b5b3454aac704a90b34c))
* `[@strict](https://github.com/strict)` when enforces enum exhaustiveness at compile time ([#629](https://github.com/Aryan-Shrivastva/EZ/issues/629)) ([be87d59](https://github.com/Aryan-Shrivastva/EZ/commit/be87d591d8c4357f87f6700196b107976df19e91))
* add cleanup for database test files ([#800](https://github.com/Aryan-Shrivastva/EZ/issues/800)) ([#829](https://github.com/Aryan-Shrivastva/EZ/issues/829)) ([35cfec8](https://github.com/Aryan-Shrivastva/EZ/commit/35cfec8bcadb9bae1b7d1bc14f551a903473804f))
* add overflow and division-by-zero checks for float arithmetic ([#798](https://github.com/Aryan-Shrivastva/EZ/issues/798)) ([#826](https://github.com/Aryan-Shrivastva/EZ/issues/826)) ([476c18d](https://github.com/Aryan-Shrivastva/EZ/commit/476c18d284d5841972a248701c6f3e22236d9196))
* add overflow/underflow checks for byte arithmetic ([#817](https://github.com/Aryan-Shrivastva/EZ/issues/817)) ([#822](https://github.com/Aryan-Shrivastva/EZ/issues/822)) ([5bd37ba](https://github.com/Aryan-Shrivastva/EZ/commit/5bd37ba8ab7e2d538d27cf163e9f7822c2e38170))
* add path validation to archive extraction functions ([#487](https://github.com/Aryan-Shrivastva/EZ/issues/487)) ([#495](https://github.com/Aryan-Shrivastva/EZ/issues/495)) ([974250a](https://github.com/Aryan-Shrivastva/EZ/commit/974250a0f45c8cbee29039c8b5e8ed002283f736))
* add type inference for stdlib module multi-return functions ([c2be2c1](https://github.com/Aryan-Shrivastva/EZ/commit/c2be2c14d2cc8040e4368a7e94a912c16464782d))
* add type inference for stdlib module multi-return functions ([f5120f8](https://github.com/Aryan-Shrivastva/EZ/commit/f5120f8c5594e64fb0856dd4bd01bb3d1c4ed1cb))
* allow byte to int conversion with int() ([#418](https://github.com/Aryan-Shrivastva/EZ/issues/418)) ([33dd463](https://github.com/Aryan-Shrivastva/EZ/commit/33dd463d19ed16fe36f03fa3b9aba641c56edffb)), closes [#403](https://github.com/Aryan-Shrivastva/EZ/issues/403)
* allow nil return for error type in user-defined functions ([4d78d05](https://github.com/Aryan-Shrivastva/EZ/commit/4d78d050ba9d314303f239c6f8f96e520bd55a51))
* allow nil return for error type in user-defined functions ([f0fd24a](https://github.com/Aryan-Shrivastva/EZ/commit/f0fd24a8bd821d782427ba30dfd42fc69ec129b3)), closes [#657](https://github.com/Aryan-Shrivastva/EZ/issues/657)
* auto-elevate to sudo when update needs root permissions ([#483](https://github.com/Aryan-Shrivastva/EZ/issues/483)) ([8cfa5c3](https://github.com/Aryan-Shrivastva/EZ/commit/8cfa5c3d2814d8ec2fa7c2593ab405829e80bdb9))
* bug fixes batch - parser, stdlib, interpreter, and enum map keys ([#454](https://github.com/Aryan-Shrivastva/EZ/issues/454)) ([f90e10f](https://github.com/Aryan-Shrivastva/EZ/commit/f90e10fd02b3946ac37341956b453db744198017)), closes [#452](https://github.com/Aryan-Shrivastva/EZ/issues/452)
* Bug: Type inference fails for most stdlib module function calls ([#878](https://github.com/Aryan-Shrivastva/EZ/issues/878)) ([4b6bfa7](https://github.com/Aryan-Shrivastva/EZ/commit/4b6bfa79c95250241da3f127230ea33317e4f037))
* CI REPL test failing on macOS ([42cb93c](https://github.com/Aryan-Shrivastva/EZ/commit/42cb93cccd995d927606e05a26fdf02e145afba2))
* CI REPL test failing on macOS ([#299](https://github.com/Aryan-Shrivastva/EZ/issues/299)) ([8b14f75](https://github.com/Aryan-Shrivastva/EZ/commit/8b14f754baf770a2bca091fa9748fa342d8b7de7))
* **ci:** add more file extension checks ([c6223fd](https://github.com/Aryan-Shrivastva/EZ/commit/c6223fd8483db67bb6336dd6b84bf6391791d765))
* **ci:** auto-merge release PRs even when a release is created in same run ([eabee09](https://github.com/Aryan-Shrivastva/EZ/commit/eabee09ea4800cc6618924636b5ed1511b2f25e8))
* **ci:** correct workflow issues in PR sanity check ([9adafdd](https://github.com/Aryan-Shrivastva/EZ/commit/9adafdd322c0b194c9fc6b20928d91f6a4280676))
* **ci:** use file -b to avoid matching on filenames in sanity check ([f01ca70](https://github.com/Aryan-Shrivastva/EZ/commit/f01ca70345368e389e7d9880e0ab4111be557e26))
* **cli:** always fetch fresh version info for `ez version` command ([ffe4979](https://github.com/Aryan-Shrivastva/EZ/commit/ffe49794dae0b9e5abd6189d5392c3ef9a45a5ec))
* **cli:** consistent arg handling and remove stale `ez run` references ([8fcb687](https://github.com/Aryan-Shrivastva/EZ/commit/8fcb687f7ef990aab376df653df3d14c29a0dc66))
* **cli:** consistent arg handling and remove stale `ez run` references ([0b7ba8c](https://github.com/Aryan-Shrivastva/EZ/commit/0b7ba8c2dbba5968c557c7bc46b3f1113be72e59)), closes [#765](https://github.com/Aryan-Shrivastva/EZ/issues/765)
* correct error codes for immutable variable/map errors ([#488](https://github.com/Aryan-Shrivastva/EZ/issues/488)) ([727ce1b](https://github.com/Aryan-Shrivastva/EZ/commit/727ce1bce576f0628aef67c1e7dd500a4c24e7d1))
* cross-module nested struct initialization ([a22d7e3](https://github.com/Aryan-Shrivastva/EZ/commit/a22d7e36822d957f741a578ee1f5df694480e503))
* cross-module nested struct initialization ([13cf3e0](https://github.com/Aryan-Shrivastva/EZ/commit/13cf3e0d46325920a59696df767a736cc473f5c5))
* december 12 patch release ([#520](https://github.com/Aryan-Shrivastva/EZ/issues/520)) ([9e75aa0](https://github.com/Aryan-Shrivastva/EZ/commit/9e75aa07bb6687d01ce471efa5bbaafd11f9c5c3))
* December 14, 2025 bug fixes ([#544](https://github.com/Aryan-Shrivastva/EZ/issues/544)) ([3169059](https://github.com/Aryan-Shrivastva/EZ/commit/31690596cf470115b4c4269d1ac6d24519c15296))
* December 15, 2025 bug fixes ([#580](https://github.com/Aryan-Shrivastva/EZ/issues/580)) ([dd6253c](https://github.com/Aryan-Shrivastva/EZ/commit/dd6253c1a8ccdeed95386b5c2a2418d7b8be0aad))
* detect integer overflow in negation and division ([#424](https://github.com/Aryan-Shrivastva/EZ/issues/424)) ([e83bdfe](https://github.com/Aryan-Shrivastva/EZ/commit/e83bdfef81ab73cad1d2b5d9062b1a8be071f2d8))
* detect missing return on all code paths at check time ([860be2a](https://github.com/Aryan-Shrivastva/EZ/commit/860be2a8843fd5f6a1a7821f64241b41e43f4b64))
* detect missing return on all code paths at check time ([81667b9](https://github.com/Aryan-Shrivastva/EZ/commit/81667b9707f2cad25c5802da7be9a74cd15d26d1)), closes [#660](https://github.com/Aryan-Shrivastva/EZ/issues/660)
* detect mixed-type enums at compile time ([#414](https://github.com/Aryan-Shrivastva/EZ/issues/414)) ([e1b8c63](https://github.com/Aryan-Shrivastva/EZ/commit/e1b8c63fd7c841d8d3aea2ad48b0d2d31483e6ca)), closes [#410](https://github.com/Aryan-Shrivastva/EZ/issues/410)
* detect variable shadowing of functions from used modules ([db505b4](https://github.com/Aryan-Shrivastva/EZ/commit/db505b40bd022a64e31752f08f1b59ad02e9bfe2))
* detect variable shadowing of functions from used modules ([#616](https://github.com/Aryan-Shrivastva/EZ/issues/616)) ([cf40e75](https://github.com/Aryan-Shrivastva/EZ/commit/cf40e75abffaee9d9a9553bc652014bda149f07e))
* disallow loop variable shadowing ([#114](https://github.com/Aryan-Shrivastva/EZ/issues/114)) ([#835](https://github.com/Aryan-Shrivastva/EZ/issues/835)) ([1cd45c2](https://github.com/Aryan-Shrivastva/EZ/commit/1cd45c272113f1473b27e4d5c3557c1892817eee))
* duplicate map keys in literal now produce compile-time error ([#641](https://github.com/Aryan-Shrivastva/EZ/issues/641)) ([06b3f91](https://github.com/Aryan-Shrivastva/EZ/commit/06b3f91df8e8add8e7a020a50d9bd60cea691482))
* duplicate map keys in literal now produce compile-time error ([#641](https://github.com/Aryan-Shrivastva/EZ/issues/641)) ([f011903](https://github.com/Aryan-Shrivastva/EZ/commit/f0119037c23adb2d7ebd610b347bf10453d7bb88))
* **ensure:** add missing validations and revert workflow change ([#866](https://github.com/Aryan-Shrivastva/EZ/issues/866)) ([e502fbd](https://github.com/Aryan-Shrivastva/EZ/commit/e502fbd2e41abf074ddff95ef71f6b1ab91373a0))
* **errors:** update E3038 hint to be more accurate ([a34b1b5](https://github.com/Aryan-Shrivastva/EZ/commit/a34b1b5a42edcfd453c5562c5c2c3df9936a9fa2))
* **evaluator:** allow modifying nested struct fields in array elements ([4d5de68](https://github.com/Aryan-Shrivastva/EZ/commit/4d5de68500fb29a6d00d729ce141704377c22df2)), closes [#859](https://github.com/Aryan-Shrivastva/EZ/issues/859)
* **evaluator:** implement short-circuit evaluation for && and || ([a9e4fe1](https://github.com/Aryan-Shrivastva/EZ/commit/a9e4fe13877775af1a2f7859cc218484a31909b2))
* **evaluator:** implement short-circuit evaluation for && and || ([2f6f0a6](https://github.com/Aryan-Shrivastva/EZ/commit/2f6f0a6bdc10484e58ade9b54c2a45ca4acd3a25))
* **evaluator:** isTruthy now checks Boolean.Value instead of pointer identity ([#354](https://github.com/Aryan-Shrivastva/EZ/issues/354)) ([18edd78](https://github.com/Aryan-Shrivastva/EZ/commit/18edd78036eb4c57637303283729496f2d3c03b1))
* **evaluator:** prevent stack overflow on self-referential structs ([6f68d98](https://github.com/Aryan-Shrivastva/EZ/commit/6f68d981901738e4b6a6d880e61a9650cbe971a8)), closes [#860](https://github.com/Aryan-Shrivastva/EZ/issues/860)
* **examples:** resolve W2009 warning in json.ez ([#357](https://github.com/Aryan-Shrivastva/EZ/issues/357)) ([#847](https://github.com/Aryan-Shrivastva/EZ/issues/847)) ([20815bb](https://github.com/Aryan-Shrivastva/EZ/commit/20815bb81d24c2c4803d89e0c65daf162941f032))
* float display now shows actual precision for debugging ([#640](https://github.com/Aryan-Shrivastva/EZ/issues/640)) ([d2051fb](https://github.com/Aryan-Shrivastva/EZ/commit/d2051fbce7ab28af8e3016c527766ec0b75bc186))
* float display now shows actual precision for debugging ([#640](https://github.com/Aryan-Shrivastva/EZ/issues/640)) ([3ef9314](https://github.com/Aryan-Shrivastva/EZ/commit/3ef93147f3104321000e65e39ebdaf7f55b7318d))
* float division by zero returns INF per IEEE 754 ([#420](https://github.com/Aryan-Shrivastva/EZ/issues/420)) ([744cf75](https://github.com/Aryan-Shrivastva/EZ/commit/744cf75b2f9188103cfd4e4734900b364c3a4781)), closes [#402](https://github.com/Aryan-Shrivastva/EZ/issues/402)
* handle .tar.gz/.zip archives in ez update ([#481](https://github.com/Aryan-Shrivastva/EZ/issues/481)) ([b7d4314](https://github.com/Aryan-Shrivastva/EZ/commit/b7d43143472a1436037fa79e63efb396e4e3126f))
* handle module-prefixed types in type compatibility checks ([#463](https://github.com/Aryan-Shrivastva/EZ/issues/463)) ([#469](https://github.com/Aryan-Shrivastva/EZ/issues/469)) ([3c597de](https://github.com/Aryan-Shrivastva/EZ/commit/3c597dec48fafc0a2cdb9c2fadee796f04bb73ac))
* implement arbitrary precision integers for i128/u128 support ([#437](https://github.com/Aryan-Shrivastva/EZ/issues/437)) ([#440](https://github.com/Aryan-Shrivastva/EZ/issues/440)) ([af4cdbf](https://github.com/Aryan-Shrivastva/EZ/commit/af4cdbfd42edcd87d5982032d06cc913cc01e75f))
* integration test overhaul and bug fixes ([#435](https://github.com/Aryan-Shrivastva/EZ/issues/435)) ([a4ad4e8](https://github.com/Aryan-Shrivastva/EZ/commit/a4ad4e8549490a5cf03b8d54bd9b48511a3af264))
* Internal type representation leaks Go type names instead of EZ types ([26dd6c1](https://github.com/Aryan-Shrivastva/EZ/commit/26dd6c12921edf797e93ecc68b08be9b7d2048cd))
* **interpreter:** add bounds check for empty ReturnValue.Values ([69c1c39](https://github.com/Aryan-Shrivastva/EZ/commit/69c1c39b14ad7ffc728fcb17e4f3979b8a7d043d))
* **interpreter:** add bounds check for empty ReturnValue.Values ([66859ca](https://github.com/Aryan-Shrivastva/EZ/commit/66859cad7eca7b3f58bcc76e28064c32956b9d75)), closes [#740](https://github.com/Aryan-Shrivastva/EZ/issues/740)
* **interpreter:** add recursion depth limit to prevent stack overflow ([ccda7b7](https://github.com/Aryan-Shrivastva/EZ/commit/ccda7b779bc8534b00f3e6a5f8396b4a7c574231)), closes [#327](https://github.com/Aryan-Shrivastva/EZ/issues/327)
* **interpreter:** check Deref() error before compound assignment ([645af52](https://github.com/Aryan-Shrivastva/EZ/commit/645af527f6e29700094504c890c38e2e0dd0d9a3))
* **interpreter:** check Deref() error before compound assignment ([836b7f7](https://github.com/Aryan-Shrivastva/EZ/commit/836b7f71bcde48738ea16f7f67528bbc197bb958)), closes [#741](https://github.com/Aryan-Shrivastva/EZ/issues/741)
* **interpreter:** display actual return type instead of RETURN_VALUE in E5012 errors ([e702d39](https://github.com/Aryan-Shrivastva/EZ/commit/e702d396e2f17db6c6e9025fd5a473f4b7ba8729))
* **interpreter:** display actual return type instead of RETURN_VALUE in E5012 errors ([#696](https://github.com/Aryan-Shrivastva/EZ/issues/696)) ([c84928e](https://github.com/Aryan-Shrivastva/EZ/commit/c84928e2a3b632833738fdf98cf257322de2c8d5))
* **interpreter:** handle multi-value assignment errors correctly ([2f08c12](https://github.com/Aryan-Shrivastva/EZ/commit/2f08c12ca9ca0c4852a249964fac49a917337b7e))
* **interpreter:** handle multi-value assignment errors correctly ([#698](https://github.com/Aryan-Shrivastva/EZ/issues/698)) ([6270ad2](https://github.com/Aryan-Shrivastva/EZ/commit/6270ad2a1d7786d0522f58c0a4371dee2a501aee))
* **interpreter:** handle void return with ensure correctly ([5580b07](https://github.com/Aryan-Shrivastva/EZ/commit/5580b0777818975cda78a27be53baee1ec72320f)), closes [#883](https://github.com/Aryan-Shrivastva/EZ/issues/883)
* **interpreter:** nested mutable parameter forwarding now works correctly ([#367](https://github.com/Aryan-Shrivastva/EZ/issues/367)) ([5762939](https://github.com/Aryan-Shrivastva/EZ/commit/57629390fb7bd4a9c53b55d9a259f853841de901)), closes [#338](https://github.com/Aryan-Shrivastva/EZ/issues/338)
* **interpreter:** set Map KeyType/ValueType when maps are created ([04e164f](https://github.com/Aryan-Shrivastva/EZ/commit/04e164fc6932f5929f3f877aa7a13245e0930c66))
* **language:** remove broken `private:module` and add typechecker validation ([3fcb311](https://github.com/Aryan-Shrivastva/EZ/commit/3fcb31107049e1143186d3f468e7b9a75fa9f7b8))
* **lexer:** preserve line numbers in string interpolation expressions ([5a236b7](https://github.com/Aryan-Shrivastva/EZ/commit/5a236b72949fb37a54a4acdcb65cbe8069978f07)), closes [#323](https://github.com/Aryan-Shrivastva/EZ/issues/323)
* make array functions modify in-place and fix remove() API ([#412](https://github.com/Aryan-Shrivastva/EZ/issues/412)) ([f6890b8](https://github.com/Aryan-Shrivastva/EZ/commit/f6890b82553549702b3d52186843ca7c11e2860d))
* make arrays.remove_all() consistent with other remove functions ([#820](https://github.com/Aryan-Shrivastva/EZ/issues/820)) ([#825](https://github.com/Aryan-Shrivastva/EZ/issues/825)) ([725d34d](https://github.com/Aryan-Shrivastva/EZ/commit/725d34dd10dc86c7d2f1bdac44af712e90c1b3fb))
* module symbol sharing and using statement resolution ([94eea8d](https://github.com/Aryan-Shrivastva/EZ/commit/94eea8dac49e6c60a121d22a0d3f1316d7d231f0))
* module symbol sharing and using statement resolution ([2b7a0d0](https://github.com/Aryan-Shrivastva/EZ/commit/2b7a0d021271e4a71f027b7aac3d86279f5eab91))
* **modules:** add type checking for multi-file modules ([#722](https://github.com/Aryan-Shrivastva/EZ/issues/722)) ([19b5006](https://github.com/Aryan-Shrivastva/EZ/commit/19b50061bcc9054d653d94bc41e63e2d0cacaeda))
* **modules:** add type checking for multi-file modules ([#722](https://github.com/Aryan-Shrivastva/EZ/issues/722)) ([d806280](https://github.com/Aryan-Shrivastva/EZ/commit/d8062804910fe308d4a8886ac481b9bf45798009))
* **modules:** report type errors in single-file modules at compile time ([#720](https://github.com/Aryan-Shrivastva/EZ/issues/720)) ([72ec320](https://github.com/Aryan-Shrivastva/EZ/commit/72ec320f48bc5ec1cb9b13fd0ab88a8f08de0e15))
* **modules:** report type errors in single-file modules at compile time ([#720](https://github.com/Aryan-Shrivastva/EZ/issues/720)) ([efcf797](https://github.com/Aryan-Shrivastva/EZ/commit/efcf79757eb22c792cce539211c5a842751d756d))
* mutable parameters now work with indexed/member expressions ([#813](https://github.com/Aryan-Shrivastva/EZ/issues/813)) ([4b7bdf2](https://github.com/Aryan-Shrivastva/EZ/commit/4b7bdf2cfd961e8623d025066d2875ddc472fcc9)), closes [#797](https://github.com/Aryan-Shrivastva/EZ/issues/797)
* os.exec now returns error on non-zero exit code ([#799](https://github.com/Aryan-Shrivastva/EZ/issues/799)) ([#827](https://github.com/Aryan-Shrivastva/EZ/issues/827)) ([06ee450](https://github.com/Aryan-Shrivastva/EZ/commit/06ee450ed261fad68b87d0b8ee0d420eeb5b6220))
* **parser:** allow blank identifier _ in for and for_each loops ([456e75d](https://github.com/Aryan-Shrivastva/EZ/commit/456e75dcdc287b762fa505561bfe8790c1f03295)), closes [#858](https://github.com/Aryan-Shrivastva/EZ/issues/858)
* **parser:** block reserved names as function parameter names ([1a52eb0](https://github.com/Aryan-Shrivastva/EZ/commit/1a52eb00148ccf97b2e80684183d541335a12985))
* **parser:** disallow import statements inside blocks and after declarations ([19118f6](https://github.com/Aryan-Shrivastva/EZ/commit/19118f6eddcecd4632c9f1d893fe78ab90251d51)), closes [#324](https://github.com/Aryan-Shrivastva/EZ/issues/324)
* **parser:** enum member access in if condition no longer causes parser error ([#358](https://github.com/Aryan-Shrivastva/EZ/issues/358)) ([6e0c5de](https://github.com/Aryan-Shrivastva/EZ/commit/6e0c5de28bc3ba4e287bd1bbbb92ac5abd126fc8))
* **parser:** handle minimum int64 literal (-9223372036854775808) ([#360](https://github.com/Aryan-Shrivastva/EZ/issues/360)) ([8c75b43](https://github.com/Aryan-Shrivastva/EZ/commit/8c75b434ff40f3e11066edbeb13a563e03a43b76))
* **parser:** prevent nil pointer crash when using 'const' as identifier ([e2177b3](https://github.com/Aryan-Shrivastva/EZ/commit/e2177b389aed3acd022e8214387146609d1b6e17)), closes [#317](https://github.com/Aryan-Shrivastva/EZ/issues/317)
* **parser:** prevent panic on comma-separated struct fields ([7886e20](https://github.com/Aryan-Shrivastva/EZ/commit/7886e206e0b309821e4d3254b935d7aa123b9d66))
* **parser:** prevent panic on comma-separated struct fields ([aa68024](https://github.com/Aryan-Shrivastva/EZ/commit/aa680242c9eb6b0317acd29ddb663054c38bac21)), closes [#750](https://github.com/Aryan-Shrivastva/EZ/issues/750)
* **parser:** use helpful error when keywords used as identifiers ([614d2bd](https://github.com/Aryan-Shrivastva/EZ/commit/614d2bda79524de9348734bbaa42c9be2ca86f0b))
* **parser:** use helpful error when keywords used as identifiers ([5ffb6e3](https://github.com/Aryan-Shrivastva/EZ/commit/5ffb6e393445ae14bf806bbaa1f3baa39174746a)), closes [#326](https://github.com/Aryan-Shrivastva/EZ/issues/326)
* **parser:** use specific error codes for struct/enum reserved names ([c86b903](https://github.com/Aryan-Shrivastva/EZ/commit/c86b9038ca1e85e46e77b93d90a8a1d56236ec4a))
* **parser:** validate enum value names against reserved keywords ([1a3f9b1](https://github.com/Aryan-Shrivastva/EZ/commit/1a3f9b18df2107bd2806fdd9b525461ffd3f2c10)), closes [#322](https://github.com/Aryan-Shrivastva/EZ/issues/322)
* **parser:** validate struct field names against reserved keywords ([a077535](https://github.com/Aryan-Shrivastva/EZ/commit/a077535e905202e19dc34fd696f02e4bc51f59d9)), closes [#321](https://github.com/Aryan-Shrivastva/EZ/issues/321)
* prevent array mutation during for_each iteration ([#812](https://github.com/Aryan-Shrivastva/EZ/issues/812)) ([00e0c83](https://github.com/Aryan-Shrivastva/EZ/commit/00e0c8396b97c2753c5da05713cbaa627f25f7f5)), closes [#796](https://github.com/Aryan-Shrivastva/EZ/issues/796)
* prevent json.encode() from overwriting EncodeAsString conversion ([#818](https://github.com/Aryan-Shrivastva/EZ/issues/818)) ([#823](https://github.com/Aryan-Shrivastva/EZ/issues/823)) ([85544e7](https://github.com/Aryan-Shrivastva/EZ/commit/85544e7e70499baba4814579564d8690d1f89f94))
* prevent panic on multi-return type mismatch with fewer names than types ([#816](https://github.com/Aryan-Shrivastva/EZ/issues/816)) ([#821](https://github.com/Aryan-Shrivastva/EZ/issues/821)) ([d983679](https://github.com/Aryan-Shrivastva/EZ/commit/d98367975d9be03db6b95e5e8ab4171f164be36c))
* properly extract first rune in strings.from_chars() ([#819](https://github.com/Aryan-Shrivastva/EZ/issues/819)) ([#824](https://github.com/Aryan-Shrivastva/EZ/issues/824)) ([060cfa6](https://github.com/Aryan-Shrivastva/EZ/commit/060cfa67b746b3ff22944a584fde367c26ce4fc2))
* properly type multi-return builtin functions like read_int() ([70519bc](https://github.com/Aryan-Shrivastva/EZ/commit/70519bc5717aedd6cfc1135bc25790c0feb354b1))
* properly type multi-return builtin functions like read_int() ([a88577e](https://github.com/Aryan-Shrivastva/EZ/commit/a88577e2cac2e8233df18b25345b53fdc3f9a4b2))
* recursively initialize nested struct fields ([#621](https://github.com/Aryan-Shrivastva/EZ/issues/621)) ([ad4f911](https://github.com/Aryan-Shrivastva/EZ/commit/ad4f911fbd6308544fcf67970280839baad41089))
* recursively initialize nested struct fields ([#621](https://github.com/Aryan-Shrivastva/EZ/issues/621)) ([3b7c653](https://github.com/Aryan-Shrivastva/EZ/commit/3b7c65385280bd48f58b505b42f6c0850e863cce))
* reject nil assignment to non-nullable types ([#416](https://github.com/Aryan-Shrivastva/EZ/issues/416)) ([40e82e3](https://github.com/Aryan-Shrivastva/EZ/commit/40e82e3f7addc2410ffa0a3ec062c4f5184a34f0)), closes [#407](https://github.com/Aryan-Shrivastva/EZ/issues/407)
* remove [@string](https://github.com/string) alias and add module suggestion hints ([#502](https://github.com/Aryan-Shrivastva/EZ/issues/502)) ([#503](https://github.com/Aryan-Shrivastva/EZ/issues/503)) ([53122a1](https://github.com/Aryan-Shrivastva/EZ/commit/53122a1350104efae0bed292167851a34e04d4a6))
* **repl:** add multi-line navigation support ([33381b0](https://github.com/Aryan-Shrivastva/EZ/commit/33381b0de8b973edf8cad6424f1ae86771c6b0b2))
* **repl:** add multi-line navigation support ([a4dcf3d](https://github.com/Aryan-Shrivastva/EZ/commit/a4dcf3dacb11dc072574a9a7c0de3c368bdeb93c)), closes [#875](https://github.com/Aryan-Shrivastva/EZ/issues/875)
* resolve merge conflict and regenerate ERRORS.md ([53cc4da](https://github.com/Aryan-Shrivastva/EZ/commit/53cc4da6f34cc3f644f19d022e5e06a6279a5cf8))
* resolve multiple bugs in stdlib, lexer, and parser ([#374](https://github.com/Aryan-Shrivastva/EZ/issues/374)) ([c4be966](https://github.com/Aryan-Shrivastva/EZ/commit/c4be9660ed9ced0f6a812d5a98ef5eea9389a813))
* resolve several interpreter bugs ([5c083d3](https://github.com/Aryan-Shrivastva/EZ/commit/5c083d33e3d0f18cef30049f3f57e184ce131d78))
* resolve stdlib bugs for arrays, strings, and math modules ([#398](https://github.com/Aryan-Shrivastva/EZ/issues/398)) ([b278ce6](https://github.com/Aryan-Shrivastva/EZ/commit/b278ce6744cba9c3e8bf22237038f8cce398bda8))
* resolve uppercase constants being parsed as struct literals ([#462](https://github.com/Aryan-Shrivastva/EZ/issues/462)) ([a406de3](https://github.com/Aryan-Shrivastva/EZ/commit/a406de3d496cf89c4f405182d5392b16405c6fc4))
* show correct file location for multi-file module errors ([#466](https://github.com/Aryan-Shrivastva/EZ/issues/466)) ([#476](https://github.com/Aryan-Shrivastva/EZ/issues/476)) ([b187e1a](https://github.com/Aryan-Shrivastva/EZ/commit/b187e1a6b8e98347acc541775eb27d6d59c98869))
* show file location in module not found error ([#461](https://github.com/Aryan-Shrivastva/EZ/issues/461)) ([#474](https://github.com/Aryan-Shrivastva/EZ/issues/474)) ([a6eec23](https://github.com/Aryan-Shrivastva/EZ/commit/a6eec2353111ce07adfca2733e93d58afe352c3d))
* show parser errors in imported modules instead of misleading undefined function errors ([e515f2c](https://github.com/Aryan-Shrivastva/EZ/commit/e515f2c8bdc67bc84aef2a050500d83e3cb317d3))
* show parser errors in imported modules instead of misleading undefined function errors ([2592b1f](https://github.com/Aryan-Shrivastva/EZ/commit/2592b1f6a51464f5aada3498a57c56db2c540172)), closes [#726](https://github.com/Aryan-Shrivastva/EZ/issues/726)
* show update notification immediately on all commands ([#499](https://github.com/Aryan-Shrivastva/EZ/issues/499)) ([c436b2f](https://github.com/Aryan-Shrivastva/EZ/commit/c436b2fe91d723317f54c5021499f45f94934ac7)), closes [#498](https://github.com/Aryan-Shrivastva/EZ/issues/498)
* sort type checker errors by file and line number ([9ca37f6](https://github.com/Aryan-Shrivastva/EZ/commit/9ca37f661b4d52121f42c27ddd6c14ac87b37f2a))
* sort type checker errors by file and line number ([c8e7f6b](https://github.com/Aryan-Shrivastva/EZ/commit/c8e7f6bc67e2b119beadd6f37f2b90dffa4fa456)), closes [#727](https://github.com/Aryan-Shrivastva/EZ/issues/727)
* stdlib functions preserve input type ([#422](https://github.com/Aryan-Shrivastva/EZ/issues/422)) ([1e91801](https://github.com/Aryan-Shrivastva/EZ/commit/1e91801ff35219dbdee45e87ae6a4af4be9453eb)), closes [#404](https://github.com/Aryan-Shrivastva/EZ/issues/404)
* **stdlib:** `arrays.set()` now modifies array in place ([411c17f](https://github.com/Aryan-Shrivastva/EZ/commit/411c17f085cb3ffe342a62d46bd318e5c898680c))
* **stdlib:** add bounds check for integer-to-byte conversion ([191ec8d](https://github.com/Aryan-Shrivastva/EZ/commit/191ec8d7cc76739995ab150a937eee9f69e8d0e7))
* **stdlib:** add bounds check for integer-to-byte conversion ([26e214f](https://github.com/Aryan-Shrivastva/EZ/commit/26e214fd72504dbeca12c470b4f3a7c6a1729470)), closes [#748](https://github.com/Aryan-Shrivastva/EZ/issues/748)
* **stdlib:** add DeclaredType to float decode functions in binary module ([2fd5582](https://github.com/Aryan-Shrivastva/EZ/commit/2fd558242534d5185e2b84a5eba5e8f8958f978a))
* **stdlib:** add ElementType to bytes.split outer array ([330cb1d](https://github.com/Aryan-Shrivastva/EZ/commit/330cb1db88060fd7a358523ee5adb6cd77ec9aac))
* **stdlib:** add ElementType to empty array in crypto.random_bytes ([02293e1](https://github.com/Aryan-Shrivastva/EZ/commit/02293e197ac63c8af5a42740a8fe0090b725152d))
* **stdlib:** arrays.insert() and arrays.remove() now modify array in-place ([3ad569a](https://github.com/Aryan-Shrivastva/EZ/commit/3ad569a9a0e3b3b39664335551d7d0e2cfbf89e2))
* **stdlib:** arrays.insert() and arrays.remove() now modify array in-place ([f26797d](https://github.com/Aryan-Shrivastva/EZ/commit/f26797ddcd2a2be3ba23f06384b3b1e3ceb4330a))
* **stdlib:** arrays.set() now modifies array in-place ([2cdb73a](https://github.com/Aryan-Shrivastva/EZ/commit/2cdb73a58be0a24dd92f41b26f9ba655cdbbb8fd)), closes [#652](https://github.com/Aryan-Shrivastva/EZ/issues/652)
* **stdlib:** make ignored file Close errors explicit in io.go ([c4048a9](https://github.com/Aryan-Shrivastva/EZ/commit/c4048a9119e5e6fc51acd9a80b22bb5233cbbf0a))
* **stdlib:** make ignored file Close errors explicit in io.go ([52dd245](https://github.com/Aryan-Shrivastva/EZ/commit/52dd245abae18f20a569d8dbae7296034218816e)), closes [#742](https://github.com/Aryan-Shrivastva/EZ/issues/742)
* **stdlib:** preserve ElementType in arrays module functions ([bb0f8de](https://github.com/Aryan-Shrivastva/EZ/commit/bb0f8dec4f1b084682e1334f1fad9dd6fc98c816)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** preserve type info in `[@maps](https://github.com/maps)` module and copyByDefault ([5a0259a](https://github.com/Aryan-Shrivastva/EZ/commit/5a0259a430b2c5a0df65e926f78b6b2c938f42c0))
* **stdlib:** preserve type info in builtins and `[@strings](https://github.com/strings)` modules ([0dc4d44](https://github.com/Aryan-Shrivastva/EZ/commit/0dc4d44efb1fa9ea29a593fa6d5829e59f075aa3))
* **stdlib:** remove redundant arrays.range() function ([f957fdd](https://github.com/Aryan-Shrivastva/EZ/commit/f957fdd594212261739e1f9ce96dfb193f842c53))
* **stdlib:** remove redundant arrays.range() function ([6a2a7ec](https://github.com/Aryan-Shrivastva/EZ/commit/6a2a7ec428f136deec22e6bd088f5109a0cc13e4)), closes [#746](https://github.com/Aryan-Shrivastva/EZ/issues/746)
* **stdlib:** set DeclaredType for floats in json module ([cb0d46f](https://github.com/Aryan-Shrivastva/EZ/commit/cb0d46f6c1d5d1065955f66b965bd0644ecbbed8)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** set ElementType for arrays in db module ([6e5086a](https://github.com/Aryan-Shrivastva/EZ/commit/6e5086a4b9e6c524267fde59ea40a150d0b6e6b5)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** set ElementType for arrays in io module ([637bbb7](https://github.com/Aryan-Shrivastva/EZ/commit/637bbb7812b7eb1430824a12efb69ec8757fb7df)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** set proper types for headers map and arrays in http module ([450c5f3](https://github.com/Aryan-Shrivastva/EZ/commit/450c5f3b7be43b4d3c3b84c1673d5b7942005371))
* **stdlib:** set proper types in os module ([bba1458](https://github.com/Aryan-Shrivastva/EZ/commit/bba1458f8bee9531162a3704e7c0a6b977456db2)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** set proper types in random module ([4739f16](https://github.com/Aryan-Shrivastva/EZ/commit/4739f161aa6872b4f0485bd7bd72ac953cc45499)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **stdlib:** show overflow error instead of invalid format for large integers ([e4ff4bb](https://github.com/Aryan-Shrivastva/EZ/commit/e4ff4bbbf01e9164aeb3199eb63dee919b78160a)), closes [#783](https://github.com/Aryan-Shrivastva/EZ/issues/783)
* **stdlib:** update getEZTypeName to return proper EZ type names ([d8ee463](https://github.com/Aryan-Shrivastva/EZ/commit/d8ee463a969c1043062f53ee4a0322ad9ad29b72))
* **stdlib:** write valid JSON when creating new database file ([ecb396a](https://github.com/Aryan-Shrivastva/EZ/commit/ecb396a07e99e93519fcb3677e89b26fa66b9956))
* **stdlib:** write valid JSON when creating new database file ([46e0da2](https://github.com/Aryan-Shrivastva/EZ/commit/46e0da26f15f7978bb05324a60d7adc3346237b3)), closes [#780](https://github.com/Aryan-Shrivastva/EZ/issues/780)
* struct mutability now respects temp/const declaration ([e91d7d9](https://github.com/Aryan-Shrivastva/EZ/commit/e91d7d998ced22e2faaea8d4fcdd56d27d73d75c))
* struct mutability now respects temp/const declaration ([#298](https://github.com/Aryan-Shrivastva/EZ/issues/298)) ([66be5c0](https://github.com/Aryan-Shrivastva/EZ/commit/66be5c04da3c65a11abcf9bf62ddffbd2cd22cc8))
* support module constants via using directive ([#677](https://github.com/Aryan-Shrivastva/EZ/issues/677)) ([a493e46](https://github.com/Aryan-Shrivastva/EZ/commit/a493e461198baad719b48c9fe3109dfad183c23d))
* support module constants via using directive ([#677](https://github.com/Aryan-Shrivastva/EZ/issues/677)) ([70dbfc3](https://github.com/Aryan-Shrivastva/EZ/commit/70dbfc362b9948cd10efc08fdcc567b59aa20819))
* suppress module name warning for files in matching directories ([#464](https://github.com/Aryan-Shrivastva/EZ/issues/464)) ([#472](https://github.com/Aryan-Shrivastva/EZ/issues/472)) ([6be1062](https://github.com/Aryan-Shrivastva/EZ/commit/6be106280f0cd375a9a93dac8197b6ab4fe34c2e))
* **tests:** strengthen db.ez assertions to actually verify behavior ([5e2bd65](https://github.com/Aryan-Shrivastva/EZ/commit/5e2bd652f620db758e20f1ec3c69193bb3b32480))
* type inference for user module functions and void type validation ([#837](https://github.com/Aryan-Shrivastva/EZ/issues/837)) ([c63c48f](https://github.com/Aryan-Shrivastva/EZ/commit/c63c48f5d9e1cfad52c914e1f018e3e75e0621e6))
* type inference for user-defined module function return types ([#811](https://github.com/Aryan-Shrivastva/EZ/issues/811)) ([be278e7](https://github.com/Aryan-Shrivastva/EZ/commit/be278e72ac1c59bf6675e688f1c13c9324ad6b56)), closes [#807](https://github.com/Aryan-Shrivastva/EZ/issues/807)
* **typechecker:** add compile-time array bounds checking ([#685](https://github.com/Aryan-Shrivastva/EZ/issues/685)) ([9fb99de](https://github.com/Aryan-Shrivastva/EZ/commit/9fb99ded85c0e18e6539deccd5cea722e603e3fb))
* **typechecker:** add compile-time array bounds checking ([#685](https://github.com/Aryan-Shrivastva/EZ/issues/685)) ([c150246](https://github.com/Aryan-Shrivastva/EZ/commit/c1502462ea431098d9c6afee0e52dfc5b8a51f26))
* **typechecker:** add warning for member access on error type ([#687](https://github.com/Aryan-Shrivastva/EZ/issues/687)) ([052ead9](https://github.com/Aryan-Shrivastva/EZ/commit/052ead9c9159f73d485600ed4cb6e4368800e126))
* **typechecker:** add warning for member access on error type ([#687](https://github.com/Aryan-Shrivastva/EZ/issues/687)) ([189a14c](https://github.com/Aryan-Shrivastva/EZ/commit/189a14c8fb669fb89bb4952ce83eb02e3b153779))
* **typechecker:** allow int/float comparison with == and != operators ([0a5b97d](https://github.com/Aryan-Shrivastva/EZ/commit/0a5b97d90dbc0b94544f03567190aa3d8c9ce39f)), closes [#857](https://github.com/Aryan-Shrivastva/EZ/issues/857)
* **typechecker:** block user-defined types/functions as parameter names ([2bea2dc](https://github.com/Aryan-Shrivastva/EZ/commit/2bea2dc6377f246adb34601f1b0e0ab058b4868a))
* **typechecker:** comprehensive validation of imported types ([#709](https://github.com/Aryan-Shrivastva/EZ/issues/709)) ([0aedff9](https://github.com/Aryan-Shrivastva/EZ/commit/0aedff9e65b5d0919574f48bdb0dd5c650784f7e))
* **typechecker:** comprehensive validation of imported types ([#709](https://github.com/Aryan-Shrivastva/EZ/issues/709)) ([88c32a7](https://github.com/Aryan-Shrivastva/EZ/commit/88c32a7254e89a52e0a891eb7683266efb30a683))
* **typechecker:** detect undefined variables in assignment targets ([f467bcf](https://github.com/Aryan-Shrivastva/EZ/commit/f467bcfcf834b3f0c89506decd42d3532b7aa9df))
* **typechecker:** detect undefined variables in assignment targets ([#665](https://github.com/Aryan-Shrivastva/EZ/issues/665)) ([24cf9b1](https://github.com/Aryan-Shrivastva/EZ/commit/24cf9b11b46ede1acf6e8e3f090300da9e377546))
* **typechecker:** enforce static typing for type-inferred variables ([e1a4437](https://github.com/Aryan-Shrivastva/EZ/commit/e1a443768b3f0afce1aab733f868fa5ff83fedb7)), closes [#329](https://github.com/Aryan-Shrivastva/EZ/issues/329)
* **typechecker:** extend overflow detection to all integer types ([#686](https://github.com/Aryan-Shrivastva/EZ/issues/686)) ([c56aa3d](https://github.com/Aryan-Shrivastva/EZ/commit/c56aa3d22302f93c5a3f8e60a17f382a94e20f36))
* **typechecker:** extend overflow detection to all integer types ([#686](https://github.com/Aryan-Shrivastva/EZ/issues/686)) ([6e0b31a](https://github.com/Aryan-Shrivastva/EZ/commit/6e0b31a1f5d1bbf3a332e53324391a9da3e4f84c))
* **typechecker:** for_each loop variables inherit mutability from collection ([fc7dd06](https://github.com/Aryan-Shrivastva/EZ/commit/fc7dd0659c3cc63a864aa17c66a701157aa2520e))
* **typechecker:** handle array and map types in struct fields ([0455540](https://github.com/Aryan-Shrivastva/EZ/commit/04555409b90e3bcc90825f2915348eecc84e6b40))
* **typechecker:** handle array and map types in struct fields ([0d1cd53](https://github.com/Aryan-Shrivastva/EZ/commit/0d1cd53cd6d738c969c4beccfad56ba49f18ddd1))
* **typechecker:** handle ignored error returns properly ([15d48a8](https://github.com/Aryan-Shrivastva/EZ/commit/15d48a8528bd282fa4c896414d27c4b43dff3442))
* **typechecker:** handle ignored error returns properly ([5f18740](https://github.com/Aryan-Shrivastva/EZ/commit/5f18740fd6a1c658e0bd4692106869db12712590)), closes [#752](https://github.com/Aryan-Shrivastva/EZ/issues/752)
* **typechecker:** infer json.decode return type from type argument ([908b026](https://github.com/Aryan-Shrivastva/EZ/commit/908b0265b1df41b75c39cd75679ee13282ab7c14))
* **typechecker:** infer types for module variables via using directive ([#677](https://github.com/Aryan-Shrivastva/EZ/issues/677)) ([584d42e](https://github.com/Aryan-Shrivastva/EZ/commit/584d42eedafcd97fefb2c731ee7108d2d3c3ea4b))
* **typechecker:** make missing return statement an error instead of warning ([1338860](https://github.com/Aryan-Shrivastva/EZ/commit/1338860d0ebabe392f05f3b311dc2d6981960a69)), closes [#318](https://github.com/Aryan-Shrivastva/EZ/issues/318)
* **typechecker:** prevent assignment of void function results ([a574be5](https://github.com/Aryan-Shrivastva/EZ/commit/a574be5a5888e1dcd6d46bd0b043a67438b3323d))
* **typechecker:** reject typeof() on void function results ([ff9897d](https://github.com/Aryan-Shrivastva/EZ/commit/ff9897d233e0b3f2ccefdd52412bd8b317552ff1))
* **typechecker:** reject void as explicit return type ([d307711](https://github.com/Aryan-Shrivastva/EZ/commit/d307711471dcbd5872c6f5f2274ec337d859e89a))
* **typechecker:** reject void in compound types ([b2182bf](https://github.com/Aryan-Shrivastva/EZ/commit/b2182bfaac444ef37a47c643cdcf591102a7eb85))
* **typechecker:** require Database type for db module functions ([2d63dc6](https://github.com/Aryan-Shrivastva/EZ/commit/2d63dc6b9b10582e26102023f9a31cd7497af976))
* **typechecker:** require Database type for db module functions ([851a6c2](https://github.com/Aryan-Shrivastva/EZ/commit/851a6c2da1c824ef48c90f4af6c4a790695a2c87)), closes [#781](https://github.com/Aryan-Shrivastva/EZ/issues/781)
* **typechecker:** resolve struct parameter member access for imported types ([#851](https://github.com/Aryan-Shrivastva/EZ/issues/851)) ([#853](https://github.com/Aryan-Shrivastva/EZ/issues/853)) ([dada274](https://github.com/Aryan-Shrivastva/EZ/commit/dada2740cca72f88d8ed56699d7596e38e368bfe))
* **typechecker:** resolve unqualified imported types in member access ([#706](https://github.com/Aryan-Shrivastva/EZ/issues/706)) ([72f8bfc](https://github.com/Aryan-Shrivastva/EZ/commit/72f8bfcde68df0de3bcf796cff8202d7c7b54c10))
* **typechecker:** resolve unqualified imported types in member access ([#706](https://github.com/Aryan-Shrivastva/EZ/issues/706)) ([e6935f8](https://github.com/Aryan-Shrivastva/EZ/commit/e6935f80b45949215101fa0300f2c367c940a87c))
* **typechecker:** resolve user module functions via 'using' directive ([b90830e](https://github.com/Aryan-Shrivastva/EZ/commit/b90830e4bea45b86cabe3aef4d0d021bad617729))
* **typechecker:** resolve user module functions via 'using' directive ([#671](https://github.com/Aryan-Shrivastva/EZ/issues/671)) ([1285737](https://github.com/Aryan-Shrivastva/EZ/commit/1285737733f4f2c9ae5bcfec0cee70fe0ec9a864))
* **typechecker:** runtime string relational operator failure ([#888](https://github.com/Aryan-Shrivastva/EZ/issues/888)) ([bc7aee4](https://github.com/Aryan-Shrivastva/EZ/commit/bc7aee4cdb23dc89e05b7ee84156cf3ee8d92137))
* **typechecker:** type errors now report correct source location ([#362](https://github.com/Aryan-Shrivastva/EZ/issues/362)) ([13cdb4e](https://github.com/Aryan-Shrivastva/EZ/commit/13cdb4ecd40f282c01749bf0f0ff65a22b6ea011))
* **typechecker:** use correct error code for missing main function ([92b3463](https://github.com/Aryan-Shrivastva/EZ/commit/92b3463ad86ecb87b809a23ae6ee3cefe66495c3)), closes [#328](https://github.com/Aryan-Shrivastva/EZ/issues/328)
* **typechecker:** validate expressions in string interpolations ([#684](https://github.com/Aryan-Shrivastva/EZ/issues/684)) ([a4d8990](https://github.com/Aryan-Shrivastva/EZ/commit/a4d8990b53e5a689bc06f40815265f0230518a5d))
* **typechecker:** validate expressions in string interpolations ([#684](https://github.com/Aryan-Shrivastva/EZ/issues/684)) ([4da234d](https://github.com/Aryan-Shrivastva/EZ/commit/4da234de0f6214635e766ae6da8dfd4a3e351d05))
* **typechecker:** validate field names in imported struct literals ([#708](https://github.com/Aryan-Shrivastva/EZ/issues/708)) ([9ecc16b](https://github.com/Aryan-Shrivastva/EZ/commit/9ecc16bb1d104ca2b00a3f3ed82c2860bb07b545))
* **typechecker:** validate field names in imported struct literals ([#708](https://github.com/Aryan-Shrivastva/EZ/issues/708)) ([a14162b](https://github.com/Aryan-Shrivastva/EZ/commit/a14162b9419700bace7d5c373fe47ad4faad01dd))
* **typechecker:** validate member access on non-struct types ([df0daee](https://github.com/Aryan-Shrivastva/EZ/commit/df0daee12fe43410abce26e41b0811adaeac3936)), closes [#313](https://github.com/Aryan-Shrivastva/EZ/issues/313)
* **types:** add DeclaredType support for Float and sized type conversions ([979e9fd](https://github.com/Aryan-Shrivastva/EZ/commit/979e9fdd28dcea79f43539b6a1eda35d959b71fe))
* **types:** typeof() returns "Database" for database objects ([ad2ed95](https://github.com/Aryan-Shrivastva/EZ/commit/ad2ed951b639438040c8a9f9711114403d3e0486)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **types:** typeof() returns "Range&lt;int&gt;" for range objects ([64cbb0a](https://github.com/Aryan-Shrivastva/EZ/commit/64cbb0a762a032e370a41b7fb1cc6f5e952aa367)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **types:** typeof() returns Ref&lt;innerType&gt; for references ([8b06b9b](https://github.com/Aryan-Shrivastva/EZ/commit/8b06b9b906d5c8f6589fbd95e47f2bb4bf75a991)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* **types:** use "File" as user-facing type name for FileHandle ([c4d9a5a](https://github.com/Aryan-Shrivastva/EZ/commit/c4d9a5abaac754c7c39d7a8117489cad0281f590)), closes [#900](https://github.com/Aryan-Shrivastva/EZ/issues/900)
* use existing E12001 instead of undefined E9020 ([09734b0](https://github.com/Aryan-Shrivastva/EZ/commit/09734b0960a5383d5bfd37d2d4c9bb9663ea951f))
* use existing E12001 instead of undefined E9020 ([f959f49](https://github.com/Aryan-Shrivastva/EZ/commit/f959f49b6f92fc65e21e7a87c87e02f9566f9af6)), closes [#769](https://github.com/Aryan-Shrivastva/EZ/issues/769)
* UTF-8 characters corrupted in interpolated strings ([#839](https://github.com/Aryan-Shrivastva/EZ/issues/839)) ([ebb34dc](https://github.com/Aryan-Shrivastva/EZ/commit/ebb34dc145235f85d7fbb3dc748132fd10a0e4bf))
* validate type assignments for imported module struct fields ([#620](https://github.com/Aryan-Shrivastva/EZ/issues/620)) ([194d74f](https://github.com/Aryan-Shrivastva/EZ/commit/194d74fa917c8690bb0baf68392447d1b6cf8089))
* validate type assignments for imported module struct fields ([#620](https://github.com/Aryan-Shrivastva/EZ/issues/620)) ([a965fb3](https://github.com/Aryan-Shrivastva/EZ/commit/a965fb3a239bf82385c1752494ba844fa33b5b80))
* version update detection and error sync workflow ([fbdb7bd](https://github.com/Aryan-Shrivastva/EZ/commit/fbdb7bd421d6419452fa901940d5c6a950cacf2e))
* version update detection and error sync workflow ([f773ddb](https://github.com/Aryan-Shrivastva/EZ/commit/f773ddb0af517295dadf3dc3f747ebe26970b53d))
* **visibility:** remove broken private:module and add typechecker validation ([bca6f4c](https://github.com/Aryan-Shrivastva/EZ/commit/bca6f4cdb5058bf60729fc72a3bf375cf27e9149)), closes [#767](https://github.com/Aryan-Shrivastva/EZ/issues/767)
* void function fixes and comprehensive type rejection ([e504704](https://github.com/Aryan-Shrivastva/EZ/commit/e504704238c91dd7ab4e8f65476412160aed4e10))
* workflow rebase, add README badges, improve test coverage ([d356bce](https://github.com/Aryan-Shrivastva/EZ/commit/d356bcef43c84c48ddabcf09e501dd50c82fffa8))
